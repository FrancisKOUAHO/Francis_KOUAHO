                            ...
                            return (
                                <div className="flex-1 fadeup-enter fadeup-enter-done" style={{transitionDelay: "0ms"}}
                                    ...
                                    <div
                                        ...
                                        <div className="flex justify-between items-center text-white"><p
                                            className="text-2xl text-white">{project.icon}</p>
                                            <div className="flex gap-2">
                                                {
                                                    project.link ? (
                                                        <a
                                                            href={project.link}
                                                            target="_blank"
                                                            className="ProjectCard_iconWrapper__rhgv1" rel="noreferrer">
                                        ...
                                        <p className="text-white">
                                            {project.description ? project.description.length > 35 ? project.description.substring(0, 35) + '...' : project.description : ''}
                                        </p>
                                        <div
                                            className={"flex gap-3 text-white" + (project.skills.length < 2 ? '' : 'flex-wrap text-white')}>
                                            {
