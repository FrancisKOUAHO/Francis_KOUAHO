        ...
        <footer className="footer">
            <div className="container">
                ...
                <div className="mask-default" style={{height: "100%"}}>
                    <p>
                        <span className="transform-footer">
                            Contact
                        </span>
                    </p>
                    <nav className="nav-hover">
                        <a href="#" target="_blank" draggable="false" title="Linkedin" className="transform-footer">
                            <img src={Linkedin} alt="linkedin"/>
                        </a>
                        <a href="mailto:kouahofrancis@gmail.com" target="_blank" draggable="false" title="Email" className="transform-footer">
                            <img src={Email} alt="Email"/>
                        </a>
                    </nav>
                </div>
