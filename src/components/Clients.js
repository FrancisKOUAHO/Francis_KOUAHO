...
const Clients = () => {
    ...
    return (
        <section className="clients" ref={AnimateScrollingClient}>
            <figure>
                <img src="https://auxfinsgastronomes.com/wp-content/uploads/2022/05/cropped-IMG_3636-300x300.png"
            ...
            <figure>
                <img
                    ...
                    alt="sudrenovationpiscine" title="sudrenovationpiscine"/>
            </figure>
            <figure>
                <img src="https://messiantcalot.fr/wp-content/uploads/2022/05/cropped-cropped-bleu-1.png"
                     alt="messiantcalot" title="messiantcalot"/>
            </figure>
            <figure>
                <img src="https://letsg0.fr/wp-content/uploads/2022/05/cropped-Frame-6-copie.png" alt="letsg0"
                     title="letsg0"/>
            </figure>
        </section>
    )
