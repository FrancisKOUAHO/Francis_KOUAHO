        ...
        <header className="header">
            ...
            <div className="container">
                ...
                <nav className="nav-hover">
                    <a id="about-ref" href="#" draggable="false" title="About" className="transform-header">A propos</a>
                    <a id="contact-ref" href="#" draggable="false" title="Contact"
                       className="transform-header">Contact</a>
                    <a href="#" draggable="false" title="Resume" target="_blank" className="transform-header">Curriculum vitae</a>
                </nav>
            </div>
        </header>
    )
